...
function initAddLB(){
	$("#add_but").linkbutton({
		iconCls:"icon-add",
		onClick:function(){
			location.href=bgPath+"fgDataMgr/exampleShow/add";
		}
	});
}
...
function initTab1(){
	tab1=$("#tab1").datagrid({
		title:"案例展示查询",
		url:bgPath+"selectExampleShowList",
		toolbar:"#toolbar",
		...
		columns:[[
			...
			{field:"imgUrl",title:"图片",width:200,formatter:function(value,row){
				return "<img style=\"width:150px;height:150px;\" src=\""+value+"\"/>";
			}},
